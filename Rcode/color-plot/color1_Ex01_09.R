...
browseURL("https://www.datanovia.com/en/blog/awesome-list-of-657-r-color-names/") # 657 named color in 7 different pdf page  browseURL("http://research.stowers-institute.org/efg/R/Color/Chart/") # expired 2024
...
barplot(x, col = cm.colors(6)) # cyan and magenta
